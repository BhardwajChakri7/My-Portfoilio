...
const Home = () => {
  return (
    <section
      ...
      <div className="relative z-10 flex flex-col-reverse md:flex-row items-center justify-center md:justify-between gap-8 md:gap-12 w-[90%] mx-auto px-6 md:px-20 mt-20">
        {/* Left: Text */}
        <motion.div
